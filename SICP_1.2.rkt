...
;one reason for why using timed-prime-test using next in not twice as fast might be that instead of a primitive operation +
...
;random-natural should work, but this language package apparently doesn't have this function
