...
;Exercise 4.44
;"eight queen puzzle
;place 8 queens on an 8x8 chess board
;so that no two queens share the same row, column, or diagonal
#|
   1   2   3   4   5   6   7   8
...
(1 1 1 8) (1 2 2 7) (1 3 3 6) (1 4 4 5) (1 5 5 4) (1 6 6 3) (1 7 7 2) (1 8 8 1)
(2 1 2 9) (2 2 3 8) (2 3 4 7) (2 4 5 6) (2 5 6 5) (2 6 7 4) (2 7 8 3) (2 8 9 2)
(3 1 3 10) (3 2 4 9) (3 3 5 8) (3 4 6 7) (3 5 7 6) (3 6 8 5) (3 7 9 4) (3 8 10 3)
|#

;positions in the nth row are generated by listing n, integers 1 to number of columns, integers starting from n, and inverse of integers starting from n
...
(define (eight-queens)
  (let ((q1 (amb (generate-row 1 8)))
    ...
    (require (distinct-lists? (list q1 q2 q3 q4 q5 q6 q7 q8)))))
